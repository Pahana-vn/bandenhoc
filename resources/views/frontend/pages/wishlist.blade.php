                            ...
                            <div class="product-card">
                                <div class="product-card-img">
                                    <a class="hover-switch" href="collection-left-sidebar.html">
                                        <img class="secondary-img"
                                            src="{{ asset('public/file') }}/image_secondary/{{ $product->image_secondary }}"
                                            alt="product-img">
                                        <img class="primary-img"
                                            src="{{ asset('public/file') }}/image/{{ $product->image }}" alt="product-img">
                                    </a>
                                    ...
                                    <div class="product-card-action product-card-action-2 justify-content-center">
                                        ...
                                        <button class="action-card action-wishlist  btn_like" data-id="{{ $product->id }}">
                                ...
                                <div class="product-card-details">
                                    ...
                                    <div class="product-card-price">
                                        ...
                                        <span
                                            class="card-price-compare text-decoration-line-through">${{ $product->price_old }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            $('.btn_like').click(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == true) {
                            ...
                            if (response.unlike == true) {
                                let containerId = 'container_product-' + product_id;
                                $('#' + containerId).remove();
                            }
                    ...
                    error: function(error) {
                        alert('You need to log in to add products to your favorites list');
                    }
                });
            })
        })
